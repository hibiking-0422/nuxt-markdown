<template>
  <div>
    <div v-if="output">
<div v-html="$md.render(output.text)"></div>
    </div>
  <input type="file" @change="fileUpload" />
<div class="mavonEditor">
      <mavon-editor :toolbars="markdownOption" :language="'ja'" v-model="value" v-on:imgAdd="$imgAdd" @change="changeText" />
  </div>
    <hr>
    <!--  入力 & 送信  -->
    <div class="input">
    ...
    <div class="output" v-if="inputDocRef != ''">
      <span>Output Text : {{ output.text }}</span>
